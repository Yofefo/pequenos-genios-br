...
import Hero from '@/components/HeroBR';
import ProblemTransformation from '@/components/ProblemTransformationBR';
import Benefits from '@/components/BenefitsBR';
import CTAIntermediario from '@/components/CTAIntermediarioBR';
import Includes from '@/components/IncludesBR';
import HowItWorks from '@/components/HowItWorksBR';
import Bonus from '@/components/BonusBR';
import MetricasVisuais from '@/components/MetricasVisuaisBR';
import CTA from '@/components/CTABR';
import Guarantee from '@/components/GuaranteeBR';
import FAQ from '@/components/FAQBR';
import Footer from '@/components/FooterBR';
import dynamic from 'next/dynamic';

// Lazy loading para componentes não críticos - Otimizado
const LazyPurchaseNotifications = dynamic(() => import('@/components/PurchaseNotificationsBR'), {
  ssr: false,
  loading: () => null
});

const LazyCarousel = dynamic(() => import('@/components/CarouselBR'), {
...
const LazySocialProof = dynamic(() => import('@/components/SocialProofBR'), {
